...
{
    public partial class rtfToolbar
    {
        #region Variables
        ...
        private string StatusBarRownumber; // current cursor position
        private int _ActualRowNumber = 1;
        public int ActualRownNumber
        {
            get { return _ActualRowNumber; }
            set
            {
                _ActualRowNumber = value;
                StatusBarRownumber = "Ze: " + value;
                LabelLineNr.Content = StatusBarRownumber;
            }
        }
        ...
        public int aktSpalte
        {
            ...
            set
            {
                ...
                LabelColumnNr.Content = spaltenangabe;
            }
        }
