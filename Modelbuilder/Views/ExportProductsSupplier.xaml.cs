...
public partial class ExportProductsSupplier : Page
{
	...
	private void ClickedSelectFolderButton(object sender, RoutedEventArgs e)
	{
		...
		var FileName = DateTime.Now.Year.ToString() + 
			...
			" - " + Languages.Cultures.ExportProductsSupplier_FileName + ".csv";

		string[] Columns = new string[] 
										{   HelperGeneral.DbProductSupplierTableFieldNameProductId, 
											...
											HelperGeneral.DbProductSupplierTableFieldNameDefaultSupplier
										};
