...
/// <summary>
/// Interaction logic for ImportBrands.xaml
/// </summary>
public partial class ImportBrands : Page
{
    ...
    private void ClickedSelectFileButton(object sender, RoutedEventArgs e)
    {
        ...
        foreach (string line in lines)
        {
            ...
            else
            {
                ...
                var ExistingBrands = _helperGeneral.CheckForRecords(HelperGeneral.DbBrandTable, new string[1, 3]
                {   { HelperGeneral.DbBrandTableFieldNameName, HelperGeneral.DbBrandTableFieldTypeName, line }    });
                ...
                else
                {
                    error = 1;
                    errorCount++;
                    errorList.Add((l, 1, Languages.Cultures.ImportBrands_Label + ": " + line.ToString() + " - " + Languages.Cultures.ImportBrands_Messagebox_Error_AlreadyExists));
                }
            }
        }
    ...
    private void PrepareEmptyCSV(object sender, RoutedEventArgs e)
    {
        ...
        _helper = new HelperClass();
        var FileName = _helper.GetFilePrefix() + Languages.Cultures.ExportBrands_FileName + ".csv";
        string[] Columns = _helper.GetBrandHeaders();
