...
public partial class ExportSupplier : Page
{
    ...
    private void ClickedSelectFolderButton(object sender, RoutedEventArgs e)
    {
        ...
        var FileName = DateTime.Now.Year.ToString() + 
            ...
            " - " + Languages.Cultures.ExportSuppliers_FileName + ".csv";

        string[] Columns = new string[] {   HelperGeneral.DbSupplierFieldNameCode, HelperGeneral.DbSupplierFieldNameName, HelperGeneral.DbSupplierFieldNameAddress1, HelperGeneral.DbSupplierFieldNameAddress2, HelperGeneral.DbSupplierFieldNameZip, HelperGeneral.DbSupplierFieldNameCity, HelperGeneral.DbSupplierFieldNameUrl, HelperGeneral.DbSupplierFieldNameCountryId, HelperGeneral.DbSupplierFieldNameCurrencyId, HelperGeneral.DbSupplierFieldNameShippingCosts, HelperGeneral.DbSupplierFieldNameMinShippingCosts, HelperGeneral.DbSupplierFieldNameOrderCosts};
