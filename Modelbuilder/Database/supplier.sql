...
CREATE TABLE IF NOT EXISTS `supplier` (
  ...
  `supplier_ShippingCosts` double(6,2) DEFAULT NULL,
  `supplier_MinShippingCosts` double(6,2) DEFAULT NULL,
  `supplier_OrderCosts` double(6,2) DEFAULT NULL,
  `supplier_MinOrderCosts` double(6,2) DEFAULT NULL,
