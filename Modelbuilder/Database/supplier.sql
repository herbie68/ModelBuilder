...
INSERT INTO `supplier` (`Id`, `Code`, `Name`, `Address1`, `Address2`, `Zip`, `City`, `Url`, `ShippingCosts`, `OrderCosts`, `MinShippingCosts`, `MinOrderCosts`, `Memo`, `CurrencyId`, `CurrencySymbol`, `CountryId`, `CountryName`) VALUES
