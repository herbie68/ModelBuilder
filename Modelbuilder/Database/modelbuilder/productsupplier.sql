...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='List for all products per supplier';
...
INSERT INTO `productsupplier` (`Id`, `Product_Id`, `Supplier_Id`, `Currency_Id`, `ProductNumber`, `ProductName`, `Price`, `DefaultSupplier`, `Created`, `Modified`) VALUES
	(1, 2, 6, 1, '16435', 'Everbuild secondelijm medium viscositeit', 4.070000171661377, '*', '2021-12-31 13:08:17', '2021-12-31 13:54:02'),
	(2, 4, 6, 1, '10893', 'Everbuild secondelijm hoge viscosoteit', 4.07, '*', '2021-12-31 14:08:49', '2021-12-31 14:08:49');
